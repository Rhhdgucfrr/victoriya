...
function Rules(){
    ...
    const filterSost =
        [
            ...
            {
                id: 2, component: CheckBox, sost: Days, object: filter.value, value: 'value', title: 'Notification', removeValue: filter.removeFilter
            },
    ...
    return(
        <div className={classes.content} >
            ...
            <div className={classes.contentRight}>
                ...
                <Plug title={'Ruls not found'} message={'Were sorry, something went wrong'} />
